...
cd "$(dirname "$0")/.."
APP_PATH="dist/Detto.app"
DMG_PATH="dist/Detto.dmg"
...
hdiutil create -volname "Detto" -srcfolder "$STAGING_DIR" -ov -format UDRW "$TEMP_DMG"
...
tell application "Finder"
  tell disk "Detto"
    ...
    set position of item "Detto.app" of container window to {120, 150}
